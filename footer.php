<footer>
	<div class="content-footer">
		<div class="logo-foter">
			<div class="logo"><img src="images/logo-footer.svg" class="img-fluid" alt=""></div>
			<div class="txt-logo">
		...
		<div class="social">
			<ul>
				...
				<li><a href=""><img src="images/sc-5.svg" class="img-fluid" alt=""></a></li>
			</ul>
		</div>
		<div class="subscribe-fter">
			...
			<div class="content-subscribe">
				<div class="head-sub">
					...
					<div class="icon"><img src="images/subscribe.svg" class="img-fluid" alt=""></div>
				</div>
				<div class="sub-form">
					<form action="">
