            ...
            <div class="h-menu-right">
                <div class="h-menu">
                    <ul>
                        ...
                        <li><a href=""><img src="images/new.svg" class="img-fluid" alt=""></a></li>
                    </ul>
                </div>
                ...
                <div class="h-translate">
                    <div class="lang-main">
                        <a href="javascript:void(0)">
                            <span><img src="images/lang1.svg" class="img-fluid" alt=""></span>
                            <span class="icon">
                    ...
                    <div class="sub-lang">
                        <ul>
                            <li><a href=""><img src="images/lang1.svg" class="img-fluid" alt=""></a></li></li>
                            <li><a href=""><img src="images/lang1.svg" class="img-fluid" alt=""></a></li></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="content-mm-mobile">
                ...
                <div class="right-mb">
                    <ul>
                        <li><a href=""><img src="images/new.svg" class="img-fluid" alt=""></a></li>
                        <li><a href="javascript:void(0)" class="mm-bar"><img src="images/bar.svg" class="img-fluid" alt=""></a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="nav-mobile text-center">
            <div class="close-mm"><a href="javascript:void(0)"><img src="images/close.svg" class="img-fluid" alt=""></a></div>
            <div class="logo-mm"><img src="images/logo-menu.svg" class="img-fluid" alt=""></div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="content-form-modal">
                        <button type="button" class="close" data-dismiss="modal"><img src="images/close.svg" class="img-fluid" alt=""></button>
                        <div class="modal-form">
                            ...
                            <div class="list-form-item">
                                <div class="item">
                                    <div class="icon"><img src="images/login-1.svg" class="img-fluid" alt=""></div>
                                    <div class="txt_field"><input type="text" class="txt_inp" placeholder="Username"></div>
                                </div>
                                <div class="item mb-0">
                                    <div class="icon"><img src="images/login-2.svg" class="img-fluid" alt=""></div>
                ...
                <div class="modal-body">
                    <div class="content-form-modal">
                        ...
                        <div class="modal-form">
                            ...
                            <div class="list-form-item">
                                <div class="item">
                                    <div class="icon"><img src="images/reg-1.svg" class="img-fluid" alt=""></div>
                                    <div class="txt_field"><input type="text" class="txt_inp" placeholder="First and Last Name"></div>
                                </div>
                                <div class="item">
                                    <div class="icon"><img src="images/reg-2.svg" class="img-fluid" alt=""></div>
                                    <div class="txt_field"><input type="text" class="txt_inp" placeholder="Email"></div>
                                </div>
                                <div class="item">
                                    <div class="icon"><img src="images/reg-3.svg" class="img-fluid" alt=""></div>
                                    <div class="txt_field"><input type="text" class="txt_inp" placeholder="Phone number (Used to receive points messages)"></div>
                                </div>
                                <div class="item">
                                    <div class="icon"><img src="images/reg-4.svg" class="img-fluid" alt=""></div>
                                    <div class="txt_field"><input type="password" class="txt_inp" placeholder="Password"></div>
                                </div>
                                <div class="item">
                                    <div class="icon"><img src="images/reg-5.svg" class="img-fluid" alt=""></div>
