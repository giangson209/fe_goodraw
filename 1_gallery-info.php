					...
					<div class="row">
						<div class="col-md-6">
							<div class="avar-detail">
								<div class="avr"><img src="images/gall.jpg" class="img-fluid w-100" alt=""></div>
							</div>
							<div class="title-detail">
								<div class="content-head-title">
									<h1>Mid Autumn Icland</h1>
									<div class="price">XXXXX</div>
									<div class="bt-cart"><a href=""><img src="images/cart.svg" class="img-fluid" alt=""></a></div>
								</div>
							</div>
						</div>
						<div class="col-md-6">
